...
<div class="label">The Platforms</div>
...
<div class="grid-3 flex-1">
  <div class="card flex-col gap-sm">
    ...
    <p class="small green">✓ Familiar dev stack feel</p>
    <p class="small red" style="margin-top: 0.5rem;">✗ Less opinionated guidance</p>
  </div>
  <div class="card flex-col gap-sm">
    ...
    <p class="small green">✓ Fast validation</p>
    <p class="small red" style="margin-top: 0.5rem;">✗ Less control</p>
  </div>
  <div class="card flex-col gap-sm">
    ...
    <p class="small green">✓ AI across lifecycle</p>
    <p class="small red" style="margin-top: 0.5rem;">✗ Heavier mental model</p>
  </div>
</div>
