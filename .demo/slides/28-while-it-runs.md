...
<div class="label">While It Runs</div>

# First generation — what Bolt is doing
...
<div class="list flex-1" style="justify-content: center;">
  ...
  <div class="list-item"><span class="num">04</span><div><h3 class="small">Live preview appears</h3><p class="small muted">The dev server starts and you see the app render — before you've touched a single file</p></div></div>
</div>

<p class="muted small" style="margin-top: 0.25rem;">What to look for: layout intent, core entities modelled, what's obviously missing.</p>
